...
class CreateUser(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[1]").send_keys("Paul")
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[2]").clear()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[2]").send_keys("Smith")
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[3]").clear()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[3]").send_keys("psmith@gmail.com")
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[4]").clear()
        driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='or with your email'])[1]/following::input[4]").send_keys("smithy123")
